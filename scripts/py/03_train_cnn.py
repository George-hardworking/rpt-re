...
from config import BATCH_SIZE, MODELS_ROOT, N_ENSEMBLE, WINDOW_DAYS
...
def train_one_seed(
    *,
    ...
    train_samples, val_samples, test_samples = split_samples(samples, seed=seed)
    log(
        f"I{image_days}/R{horizon} seed={seed} samples "
